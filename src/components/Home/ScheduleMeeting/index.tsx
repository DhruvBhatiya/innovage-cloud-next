...
const ScheduleMeeting = () => {
    ...
    sx={{
        "& .MuiPickersDay-root": {
            backgroundColor: "#f0f0f0", // Default background for all dates
            color: "#000",             // Default text color for all dates

            "&.Mui-disabled": {
                backgroundColor: "transparent",  // No background for past dates
                color: "#9e9e9e",                // Faded text color for past dates
                border: "2px solid #e0e0e0",     // Circle outline for past dates
            },
